...
public class GenericWhitWildcard {
    public static void main(String[] args) {
        ...
        //printElementsByObject(stringList);
        //printElementsByObject(objectList);List<Obbject>--> List>String>'in parent'ı değildir
        //--------------------------------------------------------------------------------------
    ...
    //alttan sınırlama
    //Integer ve Integer ın parentları ile oluşturulan listeye
    // 1 den 10 a kadar sayıları ekleyen bir method yazalım
    ...
    //wildcard:data tipinden bağımsız methodlara izin verir. ex:remove,size
